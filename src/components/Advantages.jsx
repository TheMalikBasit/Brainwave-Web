    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative flex justify-between flex-row">
          <div className="relative flex items-center w-full border border-n-1/10 z-1 h-[39rem] mb-5 p-8 rounded-3xl overflow-hidden md:mr-10 lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
                className="w-full h-full object-cover md:object-right"
                src={service1}
          ...
          <div className="relative flex items-center w-full border border-n-1/10 z-1 h-[39rem] mb-5 p-8 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
                className="w-full h-full object-cover md:object-right"
                src={service1}

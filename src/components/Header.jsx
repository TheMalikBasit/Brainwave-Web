...
const Header = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
      <div className="flex items-center px-5 lg:px-75 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={brainwave} alt="brainwave" width={190} height={40} />
        </a>
        <nav className="hidden fixed top-[5rem] left-0 reght-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent">
